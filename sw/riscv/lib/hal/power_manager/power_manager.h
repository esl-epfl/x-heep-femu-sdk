...
static power_manager_ram_map_t power_manager_ram_map[2] = {
  {
    POWER_MANAGER_RAM_0_CLK_GATE_REG_OFFSET,
    POWER_MANAGER_POWER_GATE_RAM_BLOCK_0_ACK_REG_OFFSET,
    POWER_MANAGER_RAM_0_SWITCH_REG_OFFSET,
    POWER_MANAGER_RAM_0_WAIT_ACK_SWITCH_ON_REG_OFFSET,
    POWER_MANAGER_RAM_0_ISO_REG_OFFSET,
    POWER_MANAGER_RAM_0_RETENTIVE_REG_OFFSET,
    POWER_MANAGER_MONITOR_POWER_GATE_RAM_BLOCK_0_REG_OFFSET
  },
  {
    POWER_MANAGER_RAM_1_CLK_GATE_REG_OFFSET,
    POWER_MANAGER_POWER_GATE_RAM_BLOCK_1_ACK_REG_OFFSET,
    POWER_MANAGER_RAM_1_SWITCH_REG_OFFSET,
    POWER_MANAGER_RAM_1_WAIT_ACK_SWITCH_ON_REG_OFFSET,
    POWER_MANAGER_RAM_1_ISO_REG_OFFSET,
    POWER_MANAGER_RAM_1_RETENTIVE_REG_OFFSET,
    POWER_MANAGER_MONITOR_POWER_GATE_RAM_BLOCK_1_REG_OFFSET
  },
};
